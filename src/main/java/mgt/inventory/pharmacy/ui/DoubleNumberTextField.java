 ...
 * @author Vaadin Ltd
 */
public class DoubleNumberTextField extends GeneratedVaadinTextField<DoubleNumberTextField, Double>
     ...
     */
    public DoubleNumberTextField(String label) {
        this();
        setLabel(label);
    }
     ...
     */
    public DoubleNumberTextField(String label, String placeholder) {
        this(label);
     ...
     */
    public DoubleNumberTextField(String label, Double initialValue, Double placeholder) {
        this(label);
     ...
     */
    public DoubleNumberTextField(
            ValueChangeListener<? super ComponentValueChangeEvent<DoubleNumberTextField, Double>> listener) {
        this();
     ...
     * @see #addValueChangeListener(com.vaadin.flow.component.HasValue.ValueChangeListener)
     */
    public DoubleNumberTextField(String label, Double initialValue,
                                 ValueChangeListener<? super ComponentValueChangeEvent<DoubleNumberTextField, Double>> listener) {
        this(label);
        setValue(initialValue);
        addValueChangeListener(listener);
